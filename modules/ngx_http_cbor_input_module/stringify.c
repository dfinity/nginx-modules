...
size_t cbor_str_size(cb0r_s field)
{
   ...
   case CB0R_UTF8:
      return field.end - field.start - field.header;
   case CB0R_BYTE:
      return 2 * (field.end - field.start - field.header);
   default:
...
u_char *stringify_cbor(cb0r_s field, u_char *strbuf)
{
   ...
   case CB0R_UTF8:
   {
      return ngx_copy(strbuf, field.start + field.header, cbor_payload_size(field));
   }
   break;
   case CB0R_BYTE:
   {
      return ngx_hex_dump(strbuf, field.start + field.header, cbor_payload_size(field));
   }
   break;
   default:
   {
